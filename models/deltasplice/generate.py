...
def main_for_case(case_name: str) -> None:
    ...
    # DeltaSplice applies a softmax inside the original prediction head. The reference tensor is therefore
    # post-activation splice-site probabilities, not pre-softmax logits.
