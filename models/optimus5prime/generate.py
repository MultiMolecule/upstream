...
"""Generate the Optimus 5-Prime checkpoint-parity golden fixture."""
...
RTOL = 1e-4
CHECKPOINT_SOURCE = (
    "https://raw.githubusercontent.com/pjsample/human_5utr_modeling/"
    "d53df410c7fb3fcd4bc4541bd7e8c6dc52b66fbe/modeling/saved_models/main_MRL_model.hdf5"
)
CHECKPOINT_FILENAME = "main_MRL_model.hdf5"
CHECKPOINT_SHA256 = "94b4d0badc08fb9456134492d0ceb258aa9802fefd27d334254a264b3594edf5"
CHECKPOINT_ENV_VAR = "MULTIMOLECULE_UPSTREAM_OPTIMUS5PRIME_CHECKPOINT"
...
def checkpoint_path() -> Path:
    return fetch_http_file(
        ...
        description="Optimus 5-Prime Keras checkpoint",
    )
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("case", choices=[CASE], help="Optimus 5-Prime fixture case.")
...
def main() -> None:
    ...
    if not checkpoint.is_file():
        raise FileNotFoundError(f"Optimus 5-Prime checkpoint not found: {checkpoint}")
    ...
    meta: dict[str, Any] = {
        ...
        "upstream": {
            "repository": "https://github.com/pjsample/human_5utr_modeling",
            "commit": "d53df410c7fb3fcd4bc4541bd7e8c6dc52b66fbe",
